...
#+begin_src emacs-lisp
    ...
    (use-package mu4e
      :ensure nil
      :defer 30 ; load 30 s after startup
      ...
      (setq mail-user-agent 'mu4e-user-agent  ; mu4e default email client
            ...
            mu4e-view-show-addresses t        ; show addresses, not just names
            message-kill-buffer-on-exit t     ; don't keep message buffers around
            mu4e-compose-in-new-frame nil
            mu4e-compose-format-flowed t      ; sets soft wrap
            mu4e-headers-date-format "%Y-%m-%d %H:%M"
            mu4e-html2text-command "pandoc -f html -t plain --columns 78 --strip-comments"
