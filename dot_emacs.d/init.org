...
[[https://github.com/emacs-lsp/lsp-treemacs][lsp-treemacs]] provides tree views for different aspects of your code,
...
[[https://emacs-lsp.github.io/lsp-ui/][lsp-ui]] adds a set of UI enhancements for LSP mode.
...
[[http://company-mode.github.io/][Company]] enhances in-buffer completion with a small completion popup.

[[https://github.com/sebastiencs/company-box][company-box]] further enhances the look with icons.
...
Installs the language server for Java to use with LSP mode.
