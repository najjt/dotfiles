...
#+begin_src emacs-lisp
  ...
  (when *sys/linux*
    ...
    (exwm-input-set-key (kbd "<A-k>") 'windmove-up)
    (exwm-input-set-key (kbd "<A-j>") 'windmove-down)
    (exwm-input-set-key (kbd "<A-l>") 'windmove-right)
    (exwm-input-set-key (kbd "<A-h>") 'windmove-left)
