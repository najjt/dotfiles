...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq org-directory "~/notes/org"
          ...
          org-refile-use-outline-path 'file      ; Refile between files
          org-refile-targets (quote (("backlog.org"          :maxlevel   . 3)
                                     ("../misc/computer.org" :maxlevel   . 3)
                                     ("../misc/album.org"    :level      . 1)
                                     ("privat.org"           :maxlevel   . 3)
                                     ("studier.org"          :maxlevel   . 3)))
