...
#+begin_src emacs-lisp
  ...
  (let ((hl-line-hooks '(text-mode-hook prog-mode-hook ibuffer-mode-hook)))
...
[[https://www.masteringemacs.org/article/seamlessly-merge-multiple-documentation-sources-eldoc][The built-in LSP client for Emacs]].
...
#+begin_src emacs-lisp
  ...
  ;;   :ensure nil
  ;;   :hook
  ;;   (((python-mode java-mode tex-mode) . eglot))
...
Match delimiters with [[https://github.com/Fanael/rainbow-delimiters][rainbow-delimiters]] and electric-pair-mode.
