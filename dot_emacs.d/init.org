...
#+begin_src emacs-lisp
  ...
  (defvar *afilename-cmd*
    '(("~/najjt/resources/spelling/.hunspell_personal" . "chezmoi add ~/najjt/resources/spelling/.hunspell_personal"))
    "File association list with their respective command.")

  ;; execute a bash command after saving a specific file
  ;; I use this to add my personal dictionary to chezmoi
  ...
  (use-package mu4e
    ...
    (setq
     ...
     '((:maildir "/Proton/Inbox"                :key ?i)
       ...
       (:maildir "/Proton/Folders/orders"       :key ?o)
